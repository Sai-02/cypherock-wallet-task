...
import RecieveSection from "./RecieveSection";
      ...
      <div className="p-[37px] bg-[#13161A] rounded w-full h-full">
        ...
        <div className="mt-7 grid justify-center gap-3">
          <div className="flex gap-[143px] justify-between relative">
            <div
              className={`bg-[#13161A] z-10 justify-self-center  p-1 rounded-full cursor-pointer ${
                index == 1 ? " border border-[#E19A4C]" : ""
              }`}
              onClick={() => {
                changeIndex(1);
              }}
            >
              <span
                className={`text-[#A0A0A4]  w-[23px] h-[23px] text-sm flex items-center  justify-center border border-[#707070] rounded-[50%] ${
                  index == 1 ? "bg-[#E19A4C] text-[#131619]" : ""
                } ${index > 1 ? "bg-[#E0B36A]" : ""}`}
              >
          ...
          <div className="flex justify-between">
            <div className="bg-[#13161A] justify-self-center">
              <span
                className={`text-[#A0A0A4] text-sm flex items-center  justify-center ${
                  index == 1 ? "text-[#E19A4C]" : ""
                } ${index > 1 ? "text-[#C78D4E]" : ""} `}
              >
                Device
