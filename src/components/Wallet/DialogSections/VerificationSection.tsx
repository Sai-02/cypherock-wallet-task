    ...
    return (
        <div className="mt-[44px] px-[37px]">
            <div className="flex justify-center">
                <div className="text-[#E19A4C] text-[22px] text-center bg-[#363A3E] py-[30px] px-[30px] rounded-[10px]">25BKJNKNLJL58fjkdhfk26dnfds15
                </div>
            </div>
            ...
            <div className="mt-4">
                <div className="bg-[#212427] flex py-3 px-5 items-center gap-3 ">
                    ...
                    <div className="text-[#A4A9D6] text-[14px]">Please match the address to be shown in X1 Wallet</div>
